...
## BOX model
The contencts of webpages usually are arranged as boxes including content, padding, border, and margin:
![box model](fig/CSS%20BOX%20model.png)

CSS rules for box model:

![css rule for box model](fig/CSS%20rule%20BOX%20model.png)
![css padding](fig/CSS%20padding.png)
![css border](fig/CSS%20border.png)
![css border](fig/CSS%20border%201.png)
![css margin](fig/CSS%20margin.png)
![css shorthand](fig/CSS%20shorthand.png)

## HTML alignment
By default, nearly all html elements are organized into one of two categories namely in block and in line elements.
![alignment](fig/CSS%20alignment%201.png)
![alignment](fig/CSS%20alignment%202.png)
![alignment](fig/CSS%20alignment%203.png)

You can also change block element to inline and vice versa by using CSS:
```css
#id{
...
![alignment](fig/CSS%20alignment%204.png)
...
![alignment](fig/CSS%20alignment%205.png)
